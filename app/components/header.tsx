...
export function Header() {
  return (
    <header className="site-header border-b border-ui-border sticky top-0 z-50 isolate backdrop-filter-none" style={{ backgroundColor: '#f1f3f5', backgroundImage: 'none', opacity: 1 }}>
