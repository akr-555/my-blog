...
export function Header() {
  return (
    <header className="border-b border-white/10 sticky top-0 z-50" style={{ backgroundColor: "#1e3a5f" }}>
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link
          href="#newsletter"
          className="hidden md:inline-flex items-center gap-2 text-xs font-medium border border-white/30 px-4 py-2 rounded-full text-white hover:border-white transition-colors"
        >
          <span
